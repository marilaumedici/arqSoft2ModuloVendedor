...
public class VentaDomainDTO {
	...
	public VentaDomainDTO(String ventaId, String productoId, String mailVendedor, String mailComprador, Date fechaVenta,
	...
	public VentaDomainDTO(String productoId, String mailVendedor, String mailComprador, Date fechaVenta,
			double precioIndividual, double precioFinal, Integer cantidadComprada) {
		super();
